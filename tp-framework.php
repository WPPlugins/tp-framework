					...
					case 'autocomplete':
						...
						if ( $type == 'typography' ) {
							$localize['subsets'] = array(
								'cyrillic' => esc_attr__( 'Cyrillic', 'tp-framework' ),
								'cyrillic-ext' => esc_attr__( 'Cyrillic Extended', 'tp-framework' ),
								'devanagari' => esc_attr__( 'Devanagari', 'tp-framework' ),
								'greek' => esc_attr__( 'Greek', 'tp-framework' ),
								'greek-ext' => esc_attr__( 'Greek Extended', 'tp-framework' ),
								'khmer' => esc_attr__( 'Khmer', 'tp-framework' ),
								'latin' => esc_attr__( 'Latin', 'tp-framework' ),
								'latin-ext' => esc_attr__( 'Latin Extended', 'tp-framework' ),
								'vietnamese' => esc_attr__( 'Vietnamese', 'tp-framework' ),
								'hebrew' => esc_attr__( 'Hebrew', 'tp-framework' ),
								'arabic' => esc_attr__( 'Arabic', 'tp-framework' ),
								'bengali' => esc_attr__( 'Bengali', 'tp-framework' ),
								'gujarati' => esc_attr__( 'Gujarati', 'tp-framework' ),
								'tamil' => esc_attr__( 'Tamil', 'tp-framework' ),
								'telugu' => esc_attr__( 'Telugu', 'tp-framework' ),
								'thai' => esc_attr__( 'Thai', 'tp-framework' ),
							);

							$localize['variants'] = array(
								'100' => esc_attr__( 'Thin', 'tp-framework' ),
								'100italic' => esc_attr__( 'Thin Italic', 'tp-framework' ),
								'300' => esc_attr__( 'Light', 'tp-framework' ),
								'300italic' => esc_attr__( 'Light Italic', 'tp-framework' ),
								'400' => esc_attr__( 'Normal 400', 'tp-framework' ),
								'400italic' => esc_attr__( 'Normal 400 Italic', 'tp-framework' ),
								...
								'900' => esc_attr__( 'Black 900', 'tp-framework' ),
								'900italic' => esc_attr__( 'Black 900 Italic', 'tp-framework' ),
								'ultra-light' => esc_attr__( 'Ultra-Light 100', 'tp-framework' ),
								'ultra-light-italic' => esc_attr__( 'Ultra-Light 100 Italic', 'tp-framework' ),
								'light' => esc_attr__( 'Light 200', 'tp-framework' ),
								'light-italic' => esc_attr__( 'Light 200 Italic', 'tp-framework' ),
								'book' => esc_attr__( 'Book 300', 'tp-framework' ),
								'book-italic' => esc_attr__( 'Book 300 Italic', 'tp-framework' ),
								'regular' => esc_attr__( 'Normal 400', 'tp-framework' ),
								'italic' => esc_attr__( 'Normal 400 Italic', 'tp-framework' ),
								'medium' => esc_attr__( 'Medium 500', 'tp-framework' ),
								'medium-italic' => esc_attr__( 'Medium 500 Italic', 'tp-framework' ),
								'semi-bold' => esc_attr__( 'Semi-Bold 600', 'tp-framework' ),
								'semi-bold-italic' => esc_attr__( 'Semi-Bold 600 Italic', 'tp-framework' ),
								'bold' => esc_attr__( 'Bold 700', 'tp-framework' ),
								'bold-italic' => esc_attr__( 'Bold 700 Italic', 'tp-framework' ),
								'extra-bold' => esc_attr__( 'Extra-Bold 800', 'tp-framework' ),
								'extra-bold-italic' => esc_attr__( 'Extra-Bold 800 Italic', 'tp-framework' ),
								'ultra-bold' => esc_attr__( 'Ultra-Bold 900', 'tp-framework' ),
								'ultra-bold-italic' => esc_attr__( 'Ultra-Bold 900 Italic', 'tp-framework' ),
							);
